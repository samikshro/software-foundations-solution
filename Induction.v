...
(** **** Exercise: 2 stars, advanced, recommended (plus_comm_informal)  
    ...
    Proof:
    수학적 귀납법을 이용하여 자연수의 덧셈에 교환법칙이 성립됨을 증명한다.
    ...
    - 먼저 n = 0이라면,
      ...
      주장: m = m + 0 이다.
      (이를 보이기 위해 수학적 귀납법을 이용한다.
    
        + m = 0일 경우, 0 = 0 + 0이고 직접 더함으로써 등식이 성립된다.

        + 다음으로 m = m'일 때 m' = m' + 0이 성립한다고 가정하고
          m = S m'일 때도 성립함을 보인다.
      ...
      m = m + 0 이므로 등식 0 + m = m + 0은

        0 + m = m

      으로 나타낼 수 있고 직접 더함으로써 등식이 성립된다.

    - 다음으로 n = n'일 때 n' + m = m + n'이 성립한다고 가정하고
      n = S n'일 때도 성립함을 보인다.
      ...
      주장: S (m + n') = m + S n' 이다.
      (이를 보이기 위해 m에 대하여 수학적 귀납법을 이용한다.
        ...
        + m = k일 때 S (k + n') = k + S n'가 성립한다고 가정하고
          m = S k일 때도 성립함을 보인다.
          ...
          와 같이 나타낼 수 있다.
          가정에 의해 S (k + n') = k + S n' 이므로 이를 좌변에 대입하면
      ...
      S (m + n') = m + S n' 이므로 n = S n'일 때도 성립한다.
